    ...
    <aside className="fixed left-0 top-0 z-30 flex h-screen w-64 flex-col border-r border-slate-200 bg-white shadow-sm">
      ...
      <div className="border-t border-slate-100 p-4">
        ...
        <div className="flex items-center gap-3 rounded-xl bg-slate-50 p-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-brand-gradientFrom to-brand-gradientTo text-sm font-bold text-white">
            AU
          </div>
          <div className="min-w-0">
            <div className="truncate text-sm font-semibold text-ink">Admin User</div>
            <div className="truncate text-xs text-ink-muted">Branch Manager</div>
          </div>
        </div>
      </div>
    </aside>
