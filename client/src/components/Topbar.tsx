        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <div className="hidden items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-1.5 sm:flex">
            <div className="text-right">
              <div className="text-xs font-semibold text-ink">Admin Unit 04</div>
              <div className="text-[11px] text-ink-muted">Central Jakarta Branch</div>
            </div>
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-200 text-xs font-bold text-ink">
              A
            </div>
          </div>
        </div>
